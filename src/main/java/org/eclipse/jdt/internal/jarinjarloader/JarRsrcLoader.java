...
public class JarRsrcLoader {
	...
	public static void main(String[] args) throws ClassNotFoundException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException, IOException {
	    ...
	    File file = new File(JarRsrcLoader.class.getProtectionDomain().getCodeSource().getLocation().getPath());
	    System.out.println(file.getAbsolutePath());
		JOptionPane.showMessageDialog(null, "abd"+file.getAbsolutePath());	
		
		Class c = Class.forName(mi.rsrcMainClass);
		Method main = c.getMethod(JIJConstants.MAIN_METHOD_NAME, new Class[]{args.getClass()}); 
		main.invoke((Object)null, new Object[]{args});
	     file = new File(JarRsrcLoader.class.getProtectionDomain().getCodeSource().getLocation().getPath());
	    System.out.println(file.getAbsolutePath());
		JOptionPane.showMessageDialog(null, "abe"+file.getAbsolutePath());	
	}
